                    ...
                    <>
                      ...
                      <TableRow key={`summary-${order.orderId}`}>
                        ...
                        <TableCell>
                          ...
                          {(order.status === "InProgress") && <Tooltip title="Cancel Order">
                            <IconButton
                              color="error"
                          ...
                          {(order.status === "Delivered") && <Tooltip title="Return Order">
                            <IconButton
                              color="error"
                              onClick={() => handleCancelOrder(order.orderId)}
                              sx={{ marginLeft: 2 }}
                ...
                {orders.map((order) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {(order.status === "InProgress") &&<IconButton
                        color="error"
                        onClick={() => handleCancelOrder(order.orderId)}
                        disabled={order.status === "Cancelled"}
                      >
                      ...
                      {(order.status === "Delivered") &&<IconButton
                        color="error"
                        onClick={() => handleCancelOrder(order.orderId)}
                        disabled={order.status === "Cancelled"}
                      >
